...
class Ui_Interview(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 80, 281, 221))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Собеседование</span></p></body></html>"))
        self.label.setText(_translate("Form", "ID_кандитата"))
        self.label_2.setText(_translate("Form", "Дата собеседования"))
        self.label_3.setText(_translate("Form", "Время собеседования"))
        self.label_7.setText(_translate("Form", "Место проведения"))
        self.label_4.setText(_translate("Form", "ID_решения"))
