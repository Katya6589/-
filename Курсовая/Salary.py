...
class Ui_Salary(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 80, 272, 171))
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.spinBox_4)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spinBox_5)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.spinBox_6)
        self.label_9 = QtWidgets.QLabel(Form)
        self.label_9.setGeometry(QtCore.QRect(10, 20, 681, 31))
        self.label_9.setMinimumSize(QtCore.QSize(0, 31))
        self.label_9.setObjectName("label_9")
        self.tableWidget = QtWidgets.QTableWidget(Form)
        self.tableWidget.setGeometry(QtCore.QRect(10, 280, 721, 281))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.layoutWidget = QtWidgets.QWidget(Form)
        self.layoutWidget.setGeometry(QtCore.QRect(580, 80, 137, 94))
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(580, 190, 137, 58))
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(300, 80, 103, 134))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "ID_сотрудника"))
        self.label_2.setText(_translate("Form", "Размер зарплаты"))
        self.label_7.setText(_translate("Form", "ID_штрафа"))
        self.label_3.setText(_translate("Form", "ID_доплаты"))
        self.label_8.setText(_translate("Form", "Итого"))
        self.label_9.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Зарплата</span></p></body></html>"))
