...
class Ui_Task(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Задачи</span></p></body></html>"))
        self.label.setText(_translate("Form", "ID_сотрудника"))
        self.label_2.setText(_translate("Form", "Описание задачи"))
        self.label_3.setText(_translate("Form", "Дата выдачи задачи"))
        self.label_7.setText(_translate("Form", "Дата сдачи задачи"))
