...
# Form implementation generated from reading ui file 'Vacation.ui'
#
...
class Ui_Vacation(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(741, 551)
        self.tableWidget = QtWidgets.QTableWidget(Form)
        self.tableWidget.setGeometry(QtCore.QRect(10, 260, 721, 281))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.layoutWidget_4 = QtWidgets.QWidget(Form)
        self.layoutWidget_4.setGeometry(QtCore.QRect(320, 70, 103, 134))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(580, 70, 137, 94))
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(580, 180, 137, 58))
        ...
        self.label_9.setGeometry(QtCore.QRect(10, 10, 681, 31))
        self.label_9.setMinimumSize(QtCore.QSize(0, 31))
        self.label_9.setObjectName("label_9")
        self.layoutWidget_2 = QtWidgets.QWidget(Form)
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 70, 301, 171))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Отпуск</span></p></body></html>"))
        self.label.setText(_translate("Form", "ID_сотрудника"))
        self.label_2.setText(_translate("Form", "Дата начала отпуска"))
        self.label_3.setText(_translate("Form", "Дата окончания отпуска"))
        self.label_7.setText(_translate("Form", "Тип отпуска"))
